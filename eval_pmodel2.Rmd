...
```{r}
if (!exists("out_eval_ORG"))          load( paste0(settings_calib$dir_results, "/out_eval_ORG.Rdata"))
if (!exists("out_eval_BRC"))          load( paste0(settings_calib$dir_results, "/out_eval_BRC.Rdata"))
if (!exists("out_eval_FULL"))         load( paste0(settings_calib$dir_results, "/out_eval_FULL.Rdata"))
if (!exists("out_eval_NULL"))         load( paste0(settings_calib$dir_results, "/out_eval_NULL.Rdata"))
if (!exists("out_eval_NULLpft"))      load( paste0(settings_calib$dir_results, "/out_eval_NULLpft.Rdata"))
if (!exists("out_eval_FULL_FPARitp")) load( paste0(settings_calib$dir_results, "/out_eval_FULL_FPARitp.Rdata"))
if (!exists("out_eval_FULL_EVI"))     load( paste0(settings_calib$dir_results, "/out_eval_FULL_EVI.Rdata"))
if (!exists("out_eval_FULL_DT"))      load( paste0(settings_calib$dir_results, "/out_eval_FULL_DT.Rdata"))
if (!exists("out_eval_FULL_NTsub"))   load( paste0(settings_calib$dir_results, "/out_eval_FULL_NTsub.Rdata"))
if (!exists("out_eval_FULL_Ty"))      load( paste0(settings_calib$dir_results, "/out_eval_FULL_Ty.Rdata"))
``` 
...
mod_NULL <- obs_eval_NT$ddf %>% 
            ...
            filter(sitename %in% sites_used_ddf)
...
## combine data
df_meandoy_byclim <- out_eval_FULL$gpp$fluxnet2015$data$meandoydf_byclim_stats$data %>% 
  bind_rows() %>%
  ...
  bind_rows(
    out_eval_FULL$gpp$fluxnet2015$data$meandoydf_byclim_stats$data %>% 
    bind_rows() %>% 
    mutate(setup = "FULL")
  ) %>% 
...
## SCATTER PLOT
  ...
  modobs_xdf_NT <- analyse_modobs2(
    out_eval_FULL_NTsub$gpp$fluxnet2015$data$xdf,
    "gpp_mod",
    "gpp_obs",
    type = "heat"
    )
  modobs_xdf_DT <- analyse_modobs2(
    out_eval_FULL_DT$gpp$fluxnet2015$data$xdf,
    "gpp_mod",
    "gpp_obs",
    type = "heat"
    )  
  modobs_xdf_Ty <- analyse_modobs2(
    out_eval_FULL_Ty$gpp$fluxnet2015$data$xdf,
    "gpp_mod",
    "gpp_obs",
    type = "heat"
    )  
