...
fil_sif <- "~/data/gome2_sif_downscaled/data_halfdeg/GOME_JJ_dcSIF_05deg_ANN.nc"
...
nc_full_modis <- read_nc_onefile(fil_pmodel_full_modis)
nc_full_modis$vars$gpp <- apply(nc_full_modis$vars$gpp, c(1,2), FUN = mean)
map_pmodel_full_modis <- plot_map3(nc_full_modis, colorscale = viridis, nbin = 15, plot_title = "P-model", plot_subtitle = expression( paste("g C m"^-2, " yr"^-1, "  FULL, MODIS FPAR" ) ), width = 0.01, breaks = c(seq(0, 3000, 200), Inf))

## P-model FULL MODIS, load and take mean across time, and map
nc_full_3g <- read_nc_onefile(fil_pmodel_full_3g)
nc_full_3g$vars$gpp <- apply(nc_full_3g$vars$gpp, c(1,2), FUN = mean)
map_pmodel_full_3g <- plot_map3(nc_full_3g, colorscale = viridis, nbin = 15, plot_title = "P-model", plot_subtitle = expression( paste("g C m"^-2, " yr"^-1, "  FULL, fAPAR3g" ) ), width = 0.01, breaks = c(seq(0, 3000, 200), Inf))

cowplot::plot_grid(map_sif, map_fluxcom, map_pmodel_full_modis, map_pmodel_full_3g, ncol = 2)
