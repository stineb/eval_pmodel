...
settings_calib_RED$filter_temp_min = NA
settings_calib_RED$filter_soilm_min = NA

## Get observational data (GPP based on NT method) used as target for calibration
ddf_obs_NT <- get_obs_calib( settings_calib_RED, settings_sims, settings_input )
...
settings_calib_RED_FPARitp$filter_temp_min = NA
settings_calib_RED_FPARitp$filter_soilm_min = NA
...
settings_calib_RED_EVI$filter_temp_min = NA
settings_calib_RED_EVI$filter_soilm_min = NA
...
settings_calib_RED_DT$filter_temp_min = NA
settings_calib_RED_DT$filter_soilm_min = NA

## Get observational data (GPP based on NT method) used as target for calibration
ddf_obs_DT <- get_obs_calib( settings_calib_RED_DT, settings_sims, settings_input )
...
settings_calib_RED_Ty$filter_temp_min = NA
settings_calib_RED_Ty$filter_soilm_min = NA

## Get observational data (GPP based on NT method) used as target for calibration
ddf_obs_Ty <- get_obs_calib( settings_calib_RED_Ty, settings_sims, settings_input )
