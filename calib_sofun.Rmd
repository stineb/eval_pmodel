...
| s202          | MODIS FPAR MCD15A3H, splined     | NT              | FULL            | yes        | yes         | FULL         | params_opt_calib_FULL.csv           |
| s203          | MODIS FPAR MCD15A3H, splined     | NT              | FULL            | no         | yes         | BRC          | params_opt_calib_BRC.csv            |
|---------------|----------------------------------|---------------- |-----------------|------------|-------------|--------------|----------------------------------   |
...
| s207          | MODIS FPAR MCD15A3H, splined     | Ty              | FULL            | yes        | yes         | FULL_Ty      | params_opt_calib_FULL_Ty.csv        |
|---------------|----------------------------------|---------------- |-----------------|------------|-------------|--------------|----------------------------------   |
...
if (!exists("ddf_obs_DT")){
  ddf_obs_DT <- get_obs_calib( settings_calib_FULL_DT, settings_sims, settings_input ) %>% 
    ddf_obs_DT %>% filter_days( settings_calib_FULL_DT$filter_days, settings_calib_FULL_DT$path_gepisat )
