...
# df <- out_eval_FULL$data$ddf %>%  mutate( lue_obs = gpp_obs / (fapar * ppfd_fluxnet2015), lue_mod = gpp_mod / (fapar * ppfd_fluxnet2015) ) %>%
...
dflist_eval_pmodel <- purrr::map( as.list(predictors), ~get_eval_data(., df, predictors, nsample = 12 ) ) %>%
