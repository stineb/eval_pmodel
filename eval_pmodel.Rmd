...
if (!file.exists("data/mod_RED.Rdata")){
  ...
  params_opt <- readr::read_csv( "calib_results/params_opt_RED.csv" )
...
if (!file.exists("data/out_eval_RED.Rdata")){
  out_eval_RED <- eval_sofun( mod_RED, settings_eval, settings_sims, obs_eval = obs_eval_NT, overwrite = TRUE )
...
if (!file.exists("data/mod_RED_FPARitp.Rdata")){
  ...
  ## update files containing parameter values read by model
  params_opt <- readr::read_csv( "calib_results/params_opt_RED_FPARitp.csv" )
  nothing <- update_params( params_opt, settings_sims$dir_sofun )
...
if (!file.exists("data/out_eval_RED_FPARitp.Rdata")){
  out_eval_RED_FPARitp <- eval_sofun( mod_RED_FPARitp, settings_eval, settings_sims, obs_eval = obs_eval_NT, overwrite = TRUE )
...
if (!file.exists("data/mod_RED_EVI.Rdata")){
  ...
  ## update files containing parameter values read by model
  params_opt <- readr::read_csv( "calib_results/params_opt_RED_EVI.csv" )
  nothing <- update_params( params_opt, settings_sims$dir_sofun )
...
if (!file.exists("data/out_eval_RED_EVI.Rdata")){
  out_eval_RED_EVI <- eval_sofun( mod_RED_EVI, settings_eval, settings_sims, obs_eval = obs_eval_NT, overwrite = TRUE )
...
if (!file.exists("data/mod_RED_DT.Rdata")){
  ...
  ## update files containing parameter values read by model
  params_opt <- readr::read_csv( "calib_results/params_opt_RED_DT.csv" )
  nothing <- update_params( params_opt, settings_sims$dir_sofun )
...
if (!file.exists("data/out_eval_RED_DT.Rdata")){
  out_eval_RED_DT <- eval_sofun( mod_RED_DT, settings_eval, settings_sims, obs_eval = obs_eval_DT, overwrite = TRUE )
...
if (!file.exists("data/out_eval_RED_Ty.Rdata")){
  out_eval_RED_Ty <- eval_sofun( mod_RED_Ty, settings_eval, settings_sims, obs_eval = obs_eval_Ty, overwrite = TRUE )
...
testdf <- eval_response( out_eval_RED$data$ddf, "params/params_opt_RED.csv", overwrite = FALSE, ndays_agg = 10, makepdf=FALSE, dir = "./fig/", pattern = "RED"  )
```
