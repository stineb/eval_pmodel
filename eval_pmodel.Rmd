...
if (!file.exists("data/out_eval_ORG_FPARitp.Rdata")){
  out_eval_ORG_FPARitp <- eval_sofun( mod_FULL_FPARitp, settings_eval, settings_sims, obs_eval = obs_eval_NT, overwrite = TRUE )
  save( out_eval_ORG_FPARitp, file = "data/out_eval_ORG_FPARitp.Rdata" )
} else {
  load("data/out_eval_ORG_FPARitp.Rdata")
}

row_rsqtable_FULL_FPARitp <- bind_cols( Setup = "FULL_FPARitp", getrow_statstable( out_eval_ORG_FPARitp, stat = "rsq" ) )
rm("out_eval_ORG_FPARitp")
rm("mod_FULL_FPARitp")
```
...
if (!file.exists("data/out_eval_FULL_EVI.Rdata")){
  ...
  load("data/out_eval_FULL_EVI.Rdata")
}
...
if (!file.exists("data/out_eval_FULL_DT.Rdata")){
  ...
  load("data/out_eval_FULL_DT.Rdata")
}
...
if (!file.exists("data/out_eval_FULL_Ty.Rdata")){
  ...
  load("data/out_eval_FULL_Ty.Rdata")
}
...
load("data/out_eval_FULL.Rdata")
load("data/out_eval_NULL.Rdata")
plot_modobs_spatial_annual( out_eval_ORG, xlim = c(0,4000), ylim = c(0,4000), makepdf = TRUE, pattern = "RED" )
plot_modobs_spatial_annual( out_eval_BRC, xlim = c(0,4000), ylim = c(0,4000), makepdf = TRUE, pattern = "BRC" )
plot_modobs_spatial_annual( out_eval_FULL, xlim = c(0,4000), ylim = c(0,4000), makepdf = TRUE, pattern = "FULL" )
...
plot_by_doy_allzones( out_eval_ORG, makepdf=TRUE, pattern="ORG" ) # out_eval_FULL, out_eval_FULL_EVI, 
plot_by_doy_allzones( out_eval_BRC, makepdf=TRUE, pattern="BRC" ) # out_eval_FULL, out_eval_FULL_EVI, 
plot_by_doy_allzones( out_eval_FULL, makepdf=TRUE, pattern="FULL" ) # out_eval_FULL, out_eval_FULL_EVI, 
plot_by_doy_allzones( out_eval_NULL, makepdf=TRUE, pattern="NULL" )
plot_by_doy_allzones( out_eval_FULL_EVI, makepdf=TRUE, pattern="FULL_EVI" )
...
modobs_mdf <- plot_modobs_monthly( out_eval_ORG, makepdf=TRUE, xlim=c(0,20), ylim=c(0,20), pattern = "ORG" )
modobs_mdf <- plot_modobs_monthly( out_eval_BRC, makepdf=TRUE, xlim=c(0,20), ylim=c(0,20), pattern = "BRC" )
...
modobs_anomalies_daily_ORG  <- plot_modobs_anomalies_daily( out_eval_ORG,  makepdf=TRUE, pattern = "ORG" )
modobs_anomalies_daily_BRC  <- plot_modobs_anomalies_daily( out_eval_ORG,  makepdf=TRUE, pattern = "BRC" )
...
testdf <- eval_functionalrel( out_eval_FULL$data$ddf, "calib_results/params_opt_FULL.csv", overwrite = TRUE, ndays_agg = NULL, makepdf=FALSE, dir = "./fig/", pattern = "FULL"  )
```
...
plot_dday( df_dday_agg_BRC, df_dday_agg_FULL, before=20, after=79, bias=TRUE )
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.width=7.6, fig.height=7, echo=FALSE, message=FALSE}
modobs_anomalies_daily <- plot_modobs_anomalies_daily( out_eval_ORG$data$idvdf, out_eval_ORG$data$idvdf_stats, pattern = "RED", makepdf=TRUE )
```
...
$$
```{r, fig.width=7.6, fig.height=7, echo=FALSE, message=FALSE, warning=FALSE}
modobs_meandoy <- plot_modobs_meandoy( out_eval_ORG$data$meandoydf, out_eval_ORG$data$meandoydf_stats, makepdf=TRUE, pattern = "RED" )
