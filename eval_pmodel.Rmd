...
if (!file.exists("data/out_eval_FULL_NTsub.Rdataxxx")){
  out_eval_FULL_NTsub <- eval_sofun( mod_FULL_NTsub, settings_eval, settings_sims, obs_eval = obs_eval_DT, overwrite = TRUE )
...
testdf <- eval_functionalrel( out_eval_FULL$data$ddf, "calib_results/params_opt_FULL.csv", overwrite = TRUE, ndays_agg = NULL, makepdf=FALSE, dir = "./fig/", label = "FULL"  )
```
