...
modobs_anomalies_annual_ORG  <- plot_modobs_anomalies_annual( out_eval_ORG,  makepdf=TRUE, label = "ORG" )
modobs_anomalies_annual_BRC  <- plot_modobs_anomalies_annual( out_eval_BRC,  makepdf=TRUE, label = "BRC" )
modobs_anomalies_annual_FULL <- plot_modobs_anomalies_annual( out_eval_FULL, makepdf=TRUE, label = "FULL" )
modobs_anomalies_annual_NULL <- plot_modobs_anomalies_annual( out_eval_NULL, makepdf=TRUE, label = "NULL" )
```
...
save(dflist_eval_lue_obs, file = "data/dflist_eval_lue_obs.Rdata")
